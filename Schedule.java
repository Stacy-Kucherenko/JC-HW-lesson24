...
public class Schedule implements Serializable {
	...
	private final Movie technicalBreakMovie = new Movie("Technical break ", technicalBreakTime);
	...
	public boolean addSeance(Movie movie) throws IllegalTimeFormatException {
		...
		if (isSeanceTimeFree(seance)) {
			...
			System.out.println("The seance was successfully added to the schedule");
			return true;
		} else {
			System.err.println("Adding a seance to the schedule is not possible, because this time is busy ");
			return false;
		}
	}
	...
	public boolean removeSeance(Seance removingSeance) throws IllegalTimeFormatException {
		...
		if (removingSeanceFound.isPresent()) {
			...
			System.out.println("The seance was successfully removed from the schedule");
			return true;
		} else {
			System.err.println("The entered seance is missing from the schedule ");
			return false;
		}
	}
	
	public void viewSchedule() {
		System.out.println("Seance schedule: ");
